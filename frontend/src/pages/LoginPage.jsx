...
export default function LoginPage() {
  ...
  return (
       ...
       <div className="relative w-full max-w-6xl h-[80vh] md:h-[70vh] lg:h-[95vh] mx-4">
          <BorderAnimatedContainer>
            {/* <div className='w-full flex md:flex-row'> */}
                ...
                <div className='w-full md:w-1/2 p-8 flex flex-col justify-center md:border-r border-slate-600/30'>
                        ...
                        <form onSubmit={handleSubmit} className='w-full space-y-6'>
                              ...
                              <button className='auth-btn' type='submit' disabled={isLoggingIn}>
                                  {isLoggingIn? <LoaderIcon className='w-full h-10 animate-spin mx-auto'/>:"Sign In"}
                              </button>
                        </form>
                ...
                <div className='hidden md:w-1/2 md:flex items-center justify-center p-6 bg-gradient-to-bl from-slate-800/20 to-transparent'>
                    <div>
                      <img src="/login.png" alt='login image' className='w-full h-auto'/>
                      <div className='mt-6 text-center'>
